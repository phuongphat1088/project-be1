...
<main>
  ...
  <div class="container">
    ...
    <h1 class="site-title"><i class="fa-solid fa-clock"></i> Các thú cưng đã xem gần đây <i class="fa-solid fa-circle-chevron-down"></i></h1>
    ...
    <h1 class="site-title"><i class="fa-solid fa-eye"></i> Các thú cưng được xem nhiều nhất <i class="fa-solid fa-circle-chevron-down"></i></h1>
    ...
    <h1 class="site-title"><i class="fa-solid fa-heart"></i> Các thú cưng được yêu thích nhất <i class="fa-solid fa-circle-chevron-down"></i></h1>
    <div class="row">
      <?php
