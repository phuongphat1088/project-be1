...
CREATE TABLE IF NOT EXISTS `pets` (
  ...
  `pet_photo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default.jpg',
  `pet_description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `pet_view` int NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `address` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Không',
